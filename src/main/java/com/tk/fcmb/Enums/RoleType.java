...
public enum RoleType {
    ...
    SUPER_ADMIN("SUPER_ADMIN", Sets.newHashSet(CREATE_USER,BLOCK_USER,
            UNBLOCK_USER, UPDATE_TRANSACTION, UPGRADE_MOBILE_APP_USERTYPE, UPDATE_MOBILE_NUMBER, CONFIRM_OTP,
    ...
    IT_CONTROL("IT_CONTROL", Sets.newHashSet(CREATE_USER,BLOCK_USER, UNBLOCK_USER,RESET_PASSWORD,VIEW_QUERY_MOBILE_APP_USER)),
